...
const content = {
  en: {
    ...
    cards: [
      ...
      ["Admin mediation", "The admin checks contacts, confirms matches, updates quantities and records profit only after a sale is marked sold."],
  ...
  pt: {
    ...
    cards: [
      ...
      ["Mediação do administrador", "O administrador verifica contactos, confirma matches, atualiza quantidades e regista lucro apenas depois de marcar uma venda como vendida."],
  ...
  de: {
    ...
    cards: [
      ...
      ["Admin-Vermittlung", "Der Admin prüft Kontakte, bestätigt Matches, aktualisiert Mengen und erfasst Gewinn erst nach einem bestätigten Verkauf."],
  ...
  ro: {
    ...
    cards: [
      ...
      ["Mediere admin", "Administratorul verifică contactele, confirmă potrivirile, actualizează cantitățile și calculează profitul doar după vânzare."],
  ...
  tr: {
    ...
    cards: [
      ...
      ["Admin aracılığı", "Admin kontakları kontrol eder, eşleşmeleri onaylar, miktarları günceller ve kârı sadece satıştan sonra kaydeder."],
